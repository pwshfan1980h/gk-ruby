class AddSolidRuntimeTables < ActiveRecord::Migration[8.1]
  def change
    ...
    %i[
      blocked_executions claimed_executions failed_executions ready_executions
      recurring_executions scheduled_executions
    ].each do |table|
      add_foreign_key "solid_queue_#{table}", :solid_queue_jobs,
